...
class AchievementTier(str, enum.Enum):
    ...
    PLATINUM = "platinum"
    DIAMOND = "diamond"
    # Hidden ("secret") achievements' own tier, above Diamond -- see
    # each achievement's own is_hidden flag and
    # services.achievement_service._HIDDEN_ACHIEVEMENT_CHECKS.
    VIBRANIUM = "vibranium"
    # The single "unlock everything else" achievement's own tier, above
    # Vibranium -- deliberately not earnable any other way.
    MARVELOUS = "marvelous"
