...
# prestigious, with hidden/secret achievements' Vibranium tier above
# Diamond, and the single Marvelous capstone achievement last since
...
_TIER_DISPLAY_ORDER = ["bronze", "silver", "gold", "platinum", "diamond", "vibranium", "marvelous"]
