...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.project_detail_view.sync_episode_details_requested.connect(self.sync_episode_details_requested.emit)
        ...
        self.settings_view.clean_up_duplicates_requested.connect(self.clean_up_duplicates_requested.emit)
    ...
    def show_update_prompt(self, version: str, release_notes: str) -> bool:
        ...
        Note this only downloads the new version to the user's
        Downloads folder -- it does not replace the running app or
        relaunch automatically. See
